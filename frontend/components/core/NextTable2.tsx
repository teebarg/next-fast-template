...
//     // console.log("🚀 ~ NextTable ~ pagination:", pagination)
//     // console.log("🚀 ~ NextTable ~ rows:", rows)
//     // console.log("🚀 ~ NextTable ~ header:", header)
...
//     const [visibleColumns, setVisibleColumns] = React.useState<any>(new Set([]));
//     // console.log("🚀 ~ NextTable ~ visibleColumns:", visibleColumns)
...
//         return columns.filter((column: Column) => visibleColumns.has(column.uid));
//     }, [columns, visibleColumns]);
//     // console.log("🚀 ~ headerColumns ~ headerColumns:", headerColumns)
...
//         // console.log("🚀 ~ renderCell ~ user:", user)
//         const cellValue = user[columnKey.toString()];
...
//             </div>
//         );
//     }, [columns, filterValue, statusFilter, visibleColumns, onSearchChange, onRowsPerPageChange]);
...
//                     {selectedKeys ? "All items selected" : `${selectedKeys?.size} of ${items.length} selected`}
//                 </span>
//             </div>
//         );
